...
export class PaymentDetails extends Component {
  ...
  online = (e) => {
    ...
    const data = {
      ...
      productName: e.nameType ? e.nameType : e.name,
  ...
  render() {
    ...
    return (
      <>
        <Helmet>
          <title>User | Information | Payment Information</title>
        </Helmet>
        {DataDisplay}
      </>
    );
